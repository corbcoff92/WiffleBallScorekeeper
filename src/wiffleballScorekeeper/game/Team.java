...
class Team 
{
     ...
     * The teams total number of runs should be updated using {@link scoreRun} 
     ...
     * it can be automatically updated whenever this team scores a run, using {@link scoreRun}.
